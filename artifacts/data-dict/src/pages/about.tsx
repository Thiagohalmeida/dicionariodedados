...
const criteria = [
  { label: "Campo utilizado no processo", description: "O campo é de fato usado no fluxo de compras/gestão?" },
  { label: "Campo obrigatório", description: "O preenchimento deste campo é mandatório?" },
  { label: "Nome técnico correto", description: "O nome do campo reflete adequadamente seu conteúdo?" },
  { label: "Origem do dado correta", description: "O dado vem do sistema correto?" },
  { label: "Possui regra de negócio definida", description: "Existe uma regra clara que rege este campo?" },
];
...
const impacts = [
  {
    ...
    description: "Dados validados por quem conhece o processo de negócio, não apenas a tecnologia.",
  },
  {
    icon: Users,
    title: "Colaboração",
    description: "Especialistas técnicos e de negócio trabalham juntos para garantir a qualidade.",
  },
  {
    icon: FileSearch,
    title: "Rastreabilidade",
    description: "Histórico completo de validações — quem validou, quando e com qual resultado.",
  },
  {
    icon: Hospital,
    title: "Governança em Saúde",
    description: "Suporte ao cumprimento de exigências regulatórias em compras hospitalares.",
  },
];
    ...
    <div className="max-w-5xl mx-auto space-y-16 pb-16">
      ...
      <section className="text-center pt-8 space-y-5">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-foreground leading-tight">
          Validação colaborativa de<br />
          <span className="text-primary">dicionários de dados</span>
        </h1>
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Uma plataforma que aproxima especialistas técnicos e equipes de compras hospitalares
          para garantir que os dados utilizados em processos licitatórios sejam confiáveis,
          completos e bem documentados.
        </p>
      ...
      <section className="rounded-xl border bg-card p-8 space-y-4">
        ...
        <h2 className="text-2xl font-bold">Um validador de dicionários de dados para compras em saúde</h2>
        <p className="text-muted-foreground leading-relaxed">
          Em processos de aquisição de sistemas de informação hospitalar, os fornecedores entregam
          <strong> dicionários de dados</strong> — documentos técnicos que descrevem os campos, tipos
          e origens dos dados de seus sistemas. Esses documentos são críticos para garantir
          interoperabilidade, conformidade regulatória e qualidade da informação em saúde.
        </p>
        <p className="text-muted-foreground leading-relaxed">
          O <strong>Validador DD</strong> permite que equipes multidisciplinares — gestores de TI,
          especialistas em dados e equipes de compras — revisem colaborativamente esses dicionários,
          aplicando critérios objetivos de qualidade e gerando evidências de governança de dados.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {steps.map((step) => (
            <div key={step.number} className={`rounded-xl border p-6 space-y-3 ${step.color}`}>
              <div className="flex items-start justify-between">
                <span className="text-3xl font-black opacity-20">{step.number}</span>
      ...
      <section className="rounded-xl border bg-card p-8 space-y-5">
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-bold">5 perguntas objetivas, 1 score claro</h2>
          <p className="text-muted-foreground">
            Cada campo é avaliado com base em 5 critérios binários (sim/não). Cada critério
            atendido vale 20 pontos, totalizando até 100 pontos por campo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 pt-2">
          <div className="rounded-lg bg-emerald-50 border border-emerald-100 p-3 text-center">
            ...
            <p className="text-emerald-600 text-xs font-medium mt-1">Confiável</p>
          </div>
      ...
      <section className="rounded-xl border-2 border-primary/20 bg-primary/5 p-8 text-center space-y-4">
        ...
        <h2 className="text-xl font-bold">Você faz parte da equipe de compras?</h2>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Sua participação é essencial. Ao validar os campos dos dicionários, você garante que
          os dados reflitam a realidade do processo de aquisição — algo que nenhum especialista
          técnico consegue fazer sozinho.
        </p>
        <Link href="/dictionaries">
