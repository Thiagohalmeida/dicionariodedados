...
export const PreviewExcelDictionaryResponse = zod.object({
  ...
  json_gerado: zod.object({}).passthrough().optional(),
});
...
export const ListDictionariesQueryParams = zod.object({
  page: zod
    .number()
    .min(1)
    .default(listDictionariesQueryPageDefault)
    .describe("Page number (1-based)"),
  limit: zod
    .number()
    .min(1)
    .max(listDictionariesQueryLimitMax)
    .default(listDictionariesQueryLimitDefault)
...
export const GetCriticalFieldsQueryParams = zod.object({
  page: zod
    .number()
    .min(1)
    .default(getCriticalFieldsQueryPageDefault)
    .describe("Page number (1-based)"),
  limit: zod
    .number()
    .min(1)
    .max(getCriticalFieldsQueryLimitMax)
    .default(getCriticalFieldsQueryLimitDefault)
    .describe("Number of items per page"),
});
...
export const GetDashboardResponse = zod.object({
  ...
  dictionariesByStatus: zod.array(
    zod.object({
      status: zod.string(),
      count: zod.number(),
    }),
  ),
  fieldsByClassification: zod.array(
    zod.object({
      classification: zod.string(),
      count: zod.number(),
    }),
  ),
  recentDictionaries: zod.array(
    zod.object({
      id: zod.number(),
      processo: zod.string(),
      categoria: zod.string(),
